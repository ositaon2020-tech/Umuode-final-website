...
const PANORAMIC_NODES: VRNode[] = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1542224566-6e85f2e6772f?auto=format&fit=crop&w=1600&q=80", // Forest river coordinates
    hotspots: [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&w=1605&q=80", // Festive open court entrance atmosphere
    hotspots: [
